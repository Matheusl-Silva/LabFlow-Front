...
/**
 * Gate de acesso da área de estoque. Fica no layout (e não em cada página) para
 * que uma tela nova sob esta rota já nasça protegida — o erro clássico é criar
 * `/estoque/nova` e esquecer a checagem.
 *
...
export default function EstoqueLayout({ children }: { children: React.ReactNode }) {
  return <RequireRole role={"STOCK"}>{children}</RequireRole>;
}
